...
('SAU', 'Saudi Arabia',           'Middle East',    ARRAY[],                                          1069000000000,  75000000000,  35000000, 2150000, 'SA', '🇸🇦'),
('KOR', 'South Korea',            'East Asia',      ARRAY[],                                          1710000000000,  46000000000,  52000000, 100000, 'KR', '🇰🇷'),
-- NATO / Western allies
...
-- Middle East / Africa
('ISR', 'Israel',                 'Middle East',    ARRAY[],                                           564000000000,  24000000000,   9000000,  22000, 'IL', '🇮🇱'),
('IRN', 'Iran',                   'Middle East',    ARRAY[],                                           411000000000,  10000000000,  87000000, 1648000, 'IR', '🇮🇷'),
('EGY', 'Egypt',                  'North Africa',   ARRAY[],                                           476000000000,   5000000000, 104000000, 1002000, 'EG', '🇪🇬'),
('ARE', 'United Arab Emirates',   'Middle East',    ARRAY[],                                           498000000000,  19000000000,  10000000,  84000, 'AE', '🇦🇪'),
('PAK', 'Pakistan',               'South Asia',     ARRAY['SCO'],                                      338000000000,  10000000000, 231000000, 881000, 'PK', '🇵🇰'),
-- Asia
('PRK', 'North Korea',            'East Asia',      ARRAY[],                                            18000000000,   4000000000,  26000000, 120000, 'KP', '🇰🇵'),
('TWN', 'Taiwan',                 'East Asia',      ARRAY[],                                           800000000000,  19000000000,  24000000,  36000, 'TW', '🇹🇼'),
('VNM', 'Vietnam',                'Southeast Asia', ARRAY[],                                           449000000000,   6000000000,  97000000, 331000, 'VN', '🇻🇳'),
('THA', 'Thailand',               'Southeast Asia', ARRAY[],                                           544000000000,   7000000000,  70000000, 513000, 'TH', '🇹🇭'),
('IDN', 'Indonesia',              'Southeast Asia', ARRAY[],                                          1419000000000,   9000000000, 277000000, 1905000, 'ID', '🇮🇩'),
...
('PHL', 'Philippines',            'Southeast Asia', ARRAY[],                                           471000000000,   4000000000, 114000000, 300000, 'PH', '🇵🇭'),
-- Eastern Europe / Former Soviet
('UKR', 'Ukraine',                'Eastern Europe', ARRAY[],                                           176000000000,  65000000000,  44000000, 604000, 'UA', '🇺🇦'),
('AZE', 'Azerbaijan',             'Caucasus',       ARRAY[],                                            79000000000,   3000000000,  10000000,  87000, 'AZ', '🇦🇿'),
('KAZ', 'Kazakhstan',             'Central Asia',   ARRAY['CSTO','SCO'],                               261000000000,   2000000000,  19000000, 2725000, 'KZ', '🇰🇿'),
-- Latin America
('BRA', 'Brazil',                 'South America',  ARRAY[],                                          2126000000000,  19000000000, 215000000, 8516000, 'BR', '🇧🇷'),
('MEX', 'Mexico',                 'North America',  ARRAY[],                                          1322000000000,   7000000000, 130000000, 1964000, 'MX', '🇲🇽'),
('ARG', 'Argentina',              'South America',  ARRAY[],                                           640000000000,   2000000000,  45000000, 2780000, 'AR', '🇦🇷'),
('COL', 'Colombia',               'South America',  ARRAY[],                                           363000000000,   4000000000,  51000000, 1142000, 'CO', '🇨🇴'),
('CHL', 'Chile',                  'South America',  ARRAY[],                                           319000000000,   5000000000,  19000000, 756000, 'CL', '🇨🇱'),
-- Africa
('ZAF', 'South Africa',           'Southern Africa',ARRAY[],                                           405000000000,   3000000000,  60000000, 1221000, 'ZA', '🇿🇦'),
('NGA', 'Nigeria',                'West Africa',    ARRAY[],                                           477000000000,   2000000000, 218000000, 924000, 'NG', '🇳🇬'),
('ETH', 'Ethiopia',               'East Africa',    ARRAY[],                                           155000000000,   1000000000, 126000000, 1104000, 'ET', '🇪🇹'),
-- Other significant
